...
setwd('/work/AlinaMariaNechita#3266/PPC110')
...
X_raw <- positive_data$Wins + positive_data$Losses
...
save(pred_df,
     file = "output_data/ppc_pred_positive2.RData")
...
pl1 <- ggplot(pred_df, aes(sub, pred_success_adjust)) +
  ...
  geom_line(aes(y=avg)) +
  ylim(0, 1)
ggsave('output_data/pred_all_positive2.png', pl1)